...
#countries <- c ("US", "Italy", "Germany", "Spain")
countries <- c ("India", "Brazil", "Russia", "China")
...
dates <- seq(c(as.Date("1970/3/1")), by = "day", length.out = ncol(d_sums))
...
yMarker <- 10^ceiling(log10(max(d_sums[-1])))/80
